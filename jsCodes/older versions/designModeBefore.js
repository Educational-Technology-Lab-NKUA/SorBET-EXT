...
SorterGame.prototype.loadDesignMode = function (){
  ...
  //this is design/edit
  /* this.switchModeEvent.state.value="design"
    sendEvent(this.switchModeEvent, "Entering design Mode" )*/
    ...
    $(".tableField").change((e) => {
  		...
  		this.modifyCategoryEvent = {
  			...
  			state: {
  				...
  				info: { entryscounter: i },
  				name: { old: "", new: textbox.value },
  			},
  		};
...
SorterGame.prototype.createFile = function() {
    ...
    var JSONdata =  { "gameObjects": this.dataTableRows,
                    "categories":this.categories,
                    "instructions":this.instructions,
                    "blockly":{"jsonGS":jsonGS,"jsonGP":jsonGP}};  //now instructions too
...
// this.loadData();
this.gameObjects =[];
this.categories = [{"text":language.field1},
  ...
  this.addCategoryEvent.state.info.name=name;
   ...
   /* SorterGame.prototype.updateField = function (f){
    ...
    SorterGame.prototype.sendAddObjectEvent = function (idcounter, type, times) {
      this.addObjectEvent.state.info={idcounter:idcounter, type:type, times:times};
    ...
    SorterGame.prototype.onChangeObject = function (e) {
      ...
      if (!e) return;
    	...
    	this.modifyObjectEvent = {
    		...this.modifyObjectEvent,
    		state: { ...this.modifyObjectEvent.state, idcounter: i, object: obj[0] },
    	};
